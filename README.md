...
* **🦉 Owl Director:** 사용자의 막연한 투자 전략을 구체적인 감시 룰(JSON)로 번역하고 텔레그램으로 소통합니다. 차트 분석 요청은 Meerkat Scanner에게 위임합니다.
* **🦔 Meerkat Scanner:** yfinance로 시장 데이터를 수집하고 ta-lib으로 기술적 지표(RSI, MACD, 볼린저밴드, EMA, 스토캐스틱, ADX)를 계산·해석하는 분석 전문 서브 에이전트입니다.
...
> 📐 에이전트 구조, LangGraph 흐름, 도구 명세에 대한 상세 설명은 [ARCHITECTURE.md](ARCHITECTURE.md)를 참고하세요.
