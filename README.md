...
* **🦉 Magpie Agent:** Owl Director, Hawk Picker, Meerkat Scanner, Calculate Team(Bull/Bear/Dolphin)이 LangGraph 위에서 협력해 전략, 종목, 타점을 계산합니다.
...
* `magpie_agent/agents/`: Owl Director, Meerkat Scanner, Calculate Team 노드/프롬프트/스키마
